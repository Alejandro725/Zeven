<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(40);
            $this->Cell(120,10,'Reporte de productos ingresados por mes',0,1,'C');
            $this->Ln(30);
        }
        ...
        function Tabla($headers, $data)
        {
            ...
            foreach($data as $row)
            {
                ...
                $this->Cell(63, 6, $row["marca"], 1, 0, 'C');
    ...
    if(isset($_SESSION["id"]))
    {
        ...
        $productos = Sentencias::BusquedaPM("productos", $inicio, $final);
        ...
        $primero = 'Productos ingresados en el mes de '.$mes.'';
        $pdf->Titulo($primero);
        ...
        $headers = array('Producto', 'Marca', 'Fecha de Ingreso');
