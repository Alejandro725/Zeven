<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(40);
            $this->Cell(120,10,'Reporte de cliente registrados por mes',0,1,'C');
            $this->Ln(30);
        }
        ...
        function Tabla($headers, $data)
        {
            ...
            foreach($data as $row)
            {
                ...
                $this->Cell(63, 6, $row["email"], 1, 0, 'C');
    ...
    if(isset($_SESSION["id"]))
    {
        ...
        $productos = Sentencias::ClientesM($inicio, $final);
        ...
        $primero = 'Clientes registrados en el mes de '.$mes.'';
        $pdf->Titulo($primero);
        ...
        $headers = array('Usuario', 'Correo', 'Fecha de Registro');
